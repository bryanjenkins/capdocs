  ...
  def create
    ...
    respond_to do |format|
      if @document_type.save
        format.html { redirect_to root_path, notice: 'Document type was successfully created.' }
  ...
  def update
    ...
    respond_to do |format|
      if @document_type.update_attributes(params[:document_type])
        format.html { redirect_to document_types_url, notice: 'Document type was successfully updated.' }

  ...
  def create
    ...
    respond_to do |format|
      if @business_area.save
        format.html { redirect_to root_path, notice: 'Business area was successfully created.' }
  ...
  def update
    ...
    respond_to do |format|
      if @business_area.update_attributes(params[:business_area])
        format.html { redirect_to business_areas_url, notice: 'Business area was successfully updated.' }
